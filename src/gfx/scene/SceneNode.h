#ifndef GFX_SCENE_SCENENODE_H
#define GFX_SCENE_SCENENODE_H
...
#include "gfx/geometry/Mesh.h"     // MeshData for the local-bound helper
#include "gfx/material/Material.h" // PbrMaterial (non-owning)
