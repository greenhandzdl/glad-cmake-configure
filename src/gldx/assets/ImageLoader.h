#ifndef GLDX_ASSETS_IMAGELOADER_H
#define GLDX_ASSETS_IMAGELOADER_H
 ...
 * lives in src/gldx/third_party/stb_image_impl.cpp), so this public header - and
 * the `gldx` module interface that exports it - never leaks <stb_image.h>.
 */
...
#endif // GLDX_ASSETS_IMAGELOADER_H
