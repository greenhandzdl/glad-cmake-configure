#ifndef GLDX_SHADER_SHADERLIB_H
#define GLDX_SHADER_SHADERLIB_H
 ...
 *   LightingBlock -> 1 (gldx::LightBuffer::kBinding)
 *   ShadowBlock   -> 2 (gldx::CascadedShadowMap::kShadowBinding)
